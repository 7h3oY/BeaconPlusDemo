...
public class ScanDeviceListActivity extends AppCompatActivity {
    ...
    private void showPopup(String message) {
        ...
        builder.setTitle("Bienvenido a NucleoFactory Beacons V1... Visitenos en www.nucleoweb.cl");
    ...
    private void getLocation() {
        // Obtener la ubicación exacta del teléfono a través de GPS
        ...
        if (checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
            ...
            LocationListener gpsLocationListener = new LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    mDevicesListAdapter.setPhoneLocation(latitude, longitude);

                    // Detener las actualizaciones de la ubicación después de obtenerla
                    locationManager.removeUpdates(this);
                }

                // Implementar otros métodos de LocationListener según tus necesidades
                @Override
            ...
            Log.e("tag", "Permiso de ubicación GPS denegado o GPS deshabilitado");
        }

        // Obtener la ubicación aproximada del teléfono a través de WiFi
        if (checkSelfPermission(Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED
            ...
            Log.e("tag", "Permiso de ubicación de red denegado o red deshabilitada");
        }
    }
